...
import { deleteCaseStudy } from "@/lib/actions/case-study.actions";
...
export default function DeleteCaseButton({ id, title, entityType }: DeleteProps) {
  ...
  const handleDelete = async () => {
    ...
    const result = await deleteCaseStudy(entityType, id);
