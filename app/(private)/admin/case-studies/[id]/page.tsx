...
//   // 1. Fetch existing data using the ID from the URL
//   const response = await getCaseStudyById(Number(params.id));

//   // 2. Handle if the ID doesn't exist
...
//       <CaseStudyForm initialData={response.data} />
//     </main>
//   );
// }
